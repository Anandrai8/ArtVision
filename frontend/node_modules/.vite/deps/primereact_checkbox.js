...
var Checkbox = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", rootProps, React.createElement("div", hiddenInputWrapperProps, React.createElement("input", hiddenInputProps)), React.createElement("div", inputProps, checkboxIcon)), hasTooltip && React.createElement(Tooltip, _extends({
    target: elementRef,
